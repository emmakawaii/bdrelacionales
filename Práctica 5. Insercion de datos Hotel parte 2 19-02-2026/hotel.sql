...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-02-2026 a las 16:17:01
...
(1, 5, 4, '2026-02-20', 'Muy buen servicio.'),
(2, 3, 1, '2026-01-07', 'Agradable.'),
(3, 1, 7, '2025-11-07', 'Malo, intrusivo.'),
(4, 2, 3, '2025-11-15', 'Muy buen servicio.'),
(5, 4, 2, '2025-10-02', 'Malo, no se presentó');
...
(1, 2, '2026-02-01', 8500, 'Efectivo', '8954', 'Cancelado'),
(2, 7, '2026-02-20', 6790, 'Tarjeta', '1236', 'Realizado'),
(3, 4, '2026-02-12', 1200, 'Tarjeta', '4659', 'Pendiente'),
(4, 3, '2026-02-10', 3599, 'Efectivo', '7933', 'Realizado'),
(5, 6, '2026-03-12', 10000, 'Tarjeta', '0308', 'Cancelado');
...
(1, 'Lavandería', 300),
(2, 'Lavado de auto', 950),
(3, 'Masaje con aceites naturales', 1200),
(4, 'Room Service', 800),
(5, 'Estética', 600);
...
ALTER TABLE `atencion`
  ...
  ADD CONSTRAINT `atencion_ibfk_2` FOREIGN KEY (`id_reserva`) REFERENCES `cliente` (`id_cliente`);
