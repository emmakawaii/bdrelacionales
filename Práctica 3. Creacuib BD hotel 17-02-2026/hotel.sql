...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-02-2026 a las 16:24:38
...
--
ALTER TABLE `cliente`
  ADD CONSTRAINT `cliente_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `reserva` (`id_cliente`);

--
-- Filtros para la tabla `empleado`
--
ALTER TABLE `empleado`
  ADD CONSTRAINT `empleado_ibfk_1` FOREIGN KEY (`id_hotel`) REFERENCES `habitacion` (`id_hotel`);
...
ALTER TABLE `habitacion`
  ...
  ADD CONSTRAINT `habitacion_ibfk_2` FOREIGN KEY (`id_habitacion`) REFERENCES `reserva` (`id_habitacion`);
...
--
ALTER TABLE `reserva`
  ADD CONSTRAINT `reserva_ibfk_1` FOREIGN KEY (`id_reserva`) REFERENCES `atencion` (`id_reserva`);
